...
{
    m_iRear = 0;
    memset(m_sBuf, 0, sizeof(uint8_t)*(m_iWidth+1));
}
...
{
    auto sBuf = new uint8_t[iSize]{};           // End Pointer 하나 더 추가
