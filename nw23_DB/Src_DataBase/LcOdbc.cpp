// Implementation of the CLcOdbc class.
//
////////////////////////////////////////////////////////////////////////////////
...
INT CLcOdbc::Query(char* sCmd, void* pData)
{
	return -1;
}
...
// SQL 서버 연결
INT CLcOdbc::ConnectSql(char* sDsn, char* sUID, char* sPWD)
{
	SQLCHAR		InCon[260]={0};
	SQLCHAR		sqUID[128]={0};
	SQLCHAR		sqPWD[128]={0};
...
// 엑셀 파일 연결
INT CLcOdbc::ConnectExcel(char*	sFile)
{
	SQLCHAR		InCon[260];
	SQLCHAR		OutCon[260];
	...
	hr=SQLDriverConnect(m_hDbc,nullptr,InCon,sizeof(InCon),OutCon,sizeof(OutCon),&cbOutCon, SQL_DRIVER_NOPROMPT);
...
// MDB 파일 연결
INT CLcOdbc::ConnectMdb(char*	sFile)
{
	SQLCHAR		InCon[260];
	SQLCHAR		OutCon[260];
	SQLSMALLINT cbOutCon;
...
INT CLcOdbc::SqlBind(char* sQuery, char*** sDataBufc,INT** nDataBufc, INT nBufSize)
{
	SQLRETURN	hr;
	INT			i=0;
	SQLCHAR		sSQL[1024];
