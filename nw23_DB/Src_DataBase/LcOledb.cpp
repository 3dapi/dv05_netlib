// Implementation of the CLcOledb class.
//
////////////////////////////////////////////////////////////////////////////////
...
INT CLcOledb::Create(void* p1, void* p2, void* p3, void* p4)
{
	INT hr=-1;
...
INT CLcOledb::Connect(void* pDataType, void* p1, void* p2, void* p3)
{
...
INT CLcOledb::ConnectDsnOdbc(char* sDSN, char* sUID, char* sPWD)
{
	char	sCon[512]={0};
...
INT CLcOledb::ConnectDsnOledb(char* sDSN, char* sUID, char* sPWD)
{
	char	sCon[512]={0};
...
INT CLcOledb::ConnectDsnInd(char* sDSN, char* sUID, char* sPWD)
{
	strcpy(m_sDsn, sDSN);
	strcpy(m_sUid, sUID);
	strcpy(m_sPwd, sPWD);
