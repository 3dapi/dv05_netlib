...
// Error Message
std::string LcNet_FormatMessage(DWORD hr);			// Network Message Formating
std::string LcNet_FormatMessage();					// Network Message Formating
std::string LcNet_GetNetworkError(DWORD hr);		// Network Error Message Catching
...
void	LcNet_SocketAddr(SOCKADDR_IN* pOut
						, const std::string& sIp,const std::string& sPort);		// Setting Socket Address
